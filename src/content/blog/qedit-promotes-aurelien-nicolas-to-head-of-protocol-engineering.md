...
In parallel to his work with QEDIT's R&D team, Aurel has been extremely active in the ZKProof community. He played a key role in engineering [zkInterface](https://docs.zkproof.org/pages/standards/accepted-workshop3/proposal-zkinterface.pdf), a powerful tool that helps QEDIT and other developers build customizable and application-specific ZKP solutions. Earlier this year, together with Professor Eran Tromer, Professor Justin Thaler and Daniel Benarroch, Aurel co-authored a [ZKP benchmarking proposal](https://docs.zkproof.org/pages/standards/accepted-workshop3/proposal-benchmarking.pdf) for the 3rd annual ZKProof workshop. The framework helps developers swiftly assess the performance of various ZKP schemes and identify the optimal ZKP construction for their use case.
